#!/usr/bin/env python3
"""Auto flash T113 image via USB and verify boot via serial."""
...
SDK_ROOT = "/home/ubuntu/T113-tina5v1.2-sdk"
...
def main() -> int:
    ...
    parser.add_argument("--serial-vid", default="1a86", help="自动选串口 VID")
    parser.add_argument("--serial-pid", default="55d4", help="自动选串口 PID")
