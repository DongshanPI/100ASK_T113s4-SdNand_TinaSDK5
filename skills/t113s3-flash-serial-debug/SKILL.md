---
name: "t113s3-flash-serial-debug"
description: "Standardizes T113S3 serial connection and firmware flashing workflow with recovery steps. Invoke when doing T113S3 bring-up, flashing, or USB/FEL/FES troubleshooting."
---

# T113S3 Flash And Serial Debug

本 Skill 用于统一 T113S3 硬件调试流程，覆盖：
- 串口连接与实时日志抓取
- OpenixCLI 固件烧录
- FEL -> FES 重连异常处理
