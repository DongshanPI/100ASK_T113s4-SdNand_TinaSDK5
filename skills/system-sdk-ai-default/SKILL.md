...
description: "Builds T113_S4 Linux SDK, packs t113_s4_linux_100ask_uart0.img, flashes it, and validates boot over serial. Invoke for default SDK AI development and bring-up."
---

# 系统SDK AI开发 默认使用

本 Skill 用于 T113_S4 SDK 的默认 AI 开发流程，覆盖从清理配置、编译打包到烧录与串口启动验证的完整闭环。
